...
print.MADseqLOY <- function(x, ...) {
  ...
  cat("Reference region:", paste0("chr", as.character(GenomeInfoDb::seqnames(x$par$ref.region)), ":", BiocGenerics::start(x$par$ref.region), "-", BiocGenerics::end(x$par$ref.region)), "\n")
  cat("\n")
