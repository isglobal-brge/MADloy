...
```{r, plotSample1,  fig.cap="LRR and BAF in the mLRR-Y region (shaded) of SAMPLE_1 from illustrative example"}
...
The calling is performed by using getLOY function. This function has an argument called 'pval.sig' argument that is used to control the false discovery rate. By default it is based on Bonferroni correction.
