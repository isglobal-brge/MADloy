...
Previous strategy considers mLRR-Y as a surrogate of LOY status. Here we illustrate how to perform calling (e.g LOY/normal/XYY) to stablish whether an individual is carrying an alteration in chromosome Y or not using the methodology described in @caceresEDY that uses a method to deal with the non-symetric nature of the mLRR-Y data 
...
The resulting call show that only 4 samples have true LOY events. 
